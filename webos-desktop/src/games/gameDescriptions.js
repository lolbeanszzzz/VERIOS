...
export const descriptionMap = {
  ...
  aboutApp: "Version numbers, developer credits, and the story behind VERI OS.",
  ...
  yukiDevTools: "Yuki Dev Tools loads IT Tools in a themed iframe and keeps it synced with VERI OS CSS variables.",
  ...
  steamApp: "Your game library, wrapped in a Steam-style storefront interface built right into VERI OS.",
  ...
  yukiCode: "A Monaco-powered code editor built into VERI OS, based on the same engine that runs Visual Studio Code.",
  jsDosApp:
